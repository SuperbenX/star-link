...
{
  "push": "今日最打动人的一句话（15字以内，有冲击力，像朋友对你说的一句话）。硬性要求：必须引用今天具体且独特的行运相位或行星落点（如'行运金星合你的月亮''火星在狮子座''水星逆行影响你'），结合该用户星座写出独一无二的行动指引。严禁出现与具体星象无关的通用鸡汤（如'别急着证明自己''先稳住''别躲''相信自己''加油'这类任何星座任何日期都能套用的空话）。同一天不同星座、不同日期同一星座的金句都必须完全不同——因为他们的行运相位不同。",
